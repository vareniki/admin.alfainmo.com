<div class="navbar navbar-default" style="margin-top: 10px">
  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
      <?php $solicitudes = ($solicitudes > 0) ? '<span class="badge">' . $solicitudes . '</span>'  : '' ?>
    ...
    <li<?php echo $this->App->getActiveClass($this->request, 'avisos'); ?>><?php echo $this->Html->link('<i class="glyphicon glyphicon-envelope"></i> ' . $solicitudes . '</a>', '/avisos/index', array('escape' => false)); ?> </li>
