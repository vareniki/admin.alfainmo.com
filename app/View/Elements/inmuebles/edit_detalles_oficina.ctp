...
<?php
echo $this->App->horizontalSelect('Oficina.calificacion_energetica_id', 'Calificaci&oacute;n energ&eacute;tica:', $califEnergeticas, array('size' => 8, 'labelClass' => 'obligat'));
echo $this->App->horizontalInput('Oficina.indice_energetico', 'Índice energético: <br><span>(obligatorio Pa&iacute;s Vasco)</span>', array('maxlength' => 6, 'labelClass' => 'text-info'));
echo $this->App->horizontalInput('Oficina.num_registro_energetico', 'N. Registro energético:<br><span>(obligatorio Pa&iacute;s Vasco)</span>', array('maxlength' => 50, 'labelClass' => 'text-info'));
echo $this->App->horizontalInput('Oficina.emisiones_co2', 'Emisiones CO<sub>2</sub>:', array('maxlength' => 8, 'labelClass' => 'text-info'));
