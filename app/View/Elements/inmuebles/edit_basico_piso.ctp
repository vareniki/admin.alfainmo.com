...
<div class="form-group">
  ...
  <div class="controls col-xs-7 col-lg-8 col-sm-8" id="tipoOperacion">
    ...
    echo $this->Form->checkbox('Piso.es_vpo', array('value' => 't', 'label' => 'vpo'));
    ?>
  </div>
</div>
<?php
...
<!-- Gastos de comunidad -->
<?php
echo $this->App->horizontalInput('Piso.gastos_comunidad', 'Gastos de comunidad:', array('type' => 'number', 'div' => false, 'min' => 5, 'max' => 1000));
